...
import { BFF_AUTH_ENDPOINTS } from '@/app/shared/http/constant';
import { TApiError, TApiSuccess } from '@/app/shared/http/type';

import { TLoginInput, TRegisterInput } from './auth.schema';
